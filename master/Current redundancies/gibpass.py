...
time.sleep(0.5)
print(" ")
print("deltaBillingFramework by Pranav Balaji")
print("Please authenicate for program elevation.")
time.sleep(0.5)
print("")
import os
from tkinter import *
...
def CheckLogin():
    ...
    if nameEL.get() == uname and pwordEL.get() == pword: # Checks to see if you entered the correct data.
        ...
        userblock.write(uname)
        userblock.close()
        print("logging success")
        print("--- Please manually close the authenication window! ---")
        rlbl.pack() # Pack is like .grid(), just differen
        r.mainloop()
        print("Welcome, " + uname)
        print(" ")
        print("Decrypting main program.......")
        #os.startfile(r'decrep.py')
...
def DelUser():
    ...
    Signup() # And goes back to the star!t
